...
import { Globe, HeartHandshake, LockKeyhole, ShieldCheck, Sparkles } from "lucide-react";

import { BrandingCopyright, BrandingLogo, BrandingName } from "@/components/branding/branding-logo";
    ...
    <main className="min-h-dvh overflow-hidden bg-[#fff8f1] text-[#1d163d]">
      <div className="grid min-h-dvh lg:grid-cols-[1.08fr_0.92fr]">
        ...
        <section className="relative flex items-center justify-center px-5 py-10 sm:px-8 lg:px-12">
          <div className="absolute right-5 top-5 hidden items-center gap-1 text-[#756b83] text-sm sm:flex">
